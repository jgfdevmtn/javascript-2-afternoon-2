...
/*
  Create a function named 'first' that is given 'arr' as an valument.
...
/*
  Create a function named 'last' that is given 'arr' as an valument. 
...
/*
  Create a function named 'looper' that is given family as it's only valument. 
...
/*
  Write a function called reversedLooper that is given letters as it's only valument. 
...
/*
  Write a function named evenFinder that is given nums as it's only valument.
...
/*
  Write a function called divider that is given one valument, numbersArray.
...
function divider(arr) {
  ...
  for (i = 0; i < arr.length; i++) {
    if (arr[i] % 2 === 0) {
      evensArr.push(arr[i]);
    } else oddsArr.push(arr[i]);
  }
  newArr.unshift(oddsArr);
  newArr.unshift(evensArr);
  console.log(newArr);
  return newArr;
}
...
/*
  ...
  Write a function called removeItem that is given two valuments, the first is myGroceryList, and the second is an item to remove from myGroceryList. 
  If the second valument (or the item to add or remove) matches an item in myGroceryList, remove that item from the your grocery list and return the new, updated grocery list.

  Once you do that, write another function called addItem that is given two valuments, the first is myGroceryList and the second is an item to add to your grocery list. 
...
/*
  Write a function called addTen that is given 'numbers' as it's only valument.
...
/*
  ...
  Write a function called 'longer' that is given arr1 and arr2 as it's only valuments. 
...
/*
  ...
  Your 'both' function will be given two valuments, arr1 and arr2 (from the previous example).
...
/*
  A very clean way to pass around lvale LISTS (arrays) of COLLECTIONS (objects) of Data is to have an Array full of objects. 
